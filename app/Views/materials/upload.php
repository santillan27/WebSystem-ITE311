            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">
                            <i class="fas fa-upload"></i> Upload Material for: <?= esc($course['title']) ?>
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('/admin/course/' . $course['id'] . '/upload') ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="form-text">
                                    Allowed file types: PDF, DOC, DOCX, PPT, PPTX, XLS, XLSX, TXT (Max size: 10MB)
                                </div>
                            </div>
                ...
                <div class="card shadow mt-4">
                    ...
                    <div class="card-body">
                        <p><strong>Title:</strong> <?= esc($course['title']) ?></p>
                        <p><strong>Description:</strong> <?= esc($course['description'] ?? 'N/A') ?></p>
                    </div>
                </div>
            </div>
        </div>
